...
import 'package:supreme_institution/services/auth_storage_service.dart';
...
class _LoginScreenState extends State<LoginScreen> {
        ...
        content: SizedBox(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                const Text(
                  'QR Med is a smart equipment management system. We onboard your institution, calculate required equipment based on seats, departments, and standards, and digitally manage every asset using QR technology.',
                  style: TextStyle(fontSize: 14, height: 1.5),
                ),
                const SizedBox(height: 16),
                const Text(
                  'Each equipment receives a QR sticker generated by the QR Med app, making tracking, maintenance, and inspections simple and transparent.',
                  style: TextStyle(fontSize: 14, height: 1.5),
                ),
                const SizedBox(height: 24),
                _buildAboutSection(
                  title: '✅ How QR Med Works',
                  items: [
  ...
  void _login() async {
    ...
    // Fetch latest data from Firestore before login to ensure cross-device sync
    ...
    try {
      ...
      debugPrint("Error fetching data during login: $e");
      // Continue anyway, maybe the data is already there or it's a network glitch
    }
